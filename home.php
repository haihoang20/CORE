...
<script>
  ...
  //var cookie_hash = window.location.hash;
  //var cookie_value = cookie_hash.substr(1,cookie_hash.substr-2);
...
//echo "<script>alert('Cookie name is " . $cookie_name . " and Cookie value is " . $_COOKIE[$cookie_name] . "');</script>";
