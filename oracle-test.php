...
<p> Advanced search of reviews: </p>
<form method="GET" action="oracle-test.php">
...
<font size="2"> Earliest Written Date (YYYY-MM-DD) </font><input type="text" name="datebound" size="6">
<font size="2"> Comment contains </font><input type="text" name="commentcontains" size="6">
<font size="2"> Skills desired (separate each by comma), at least one of: </font><input type="text" name="skillsreq" size="6">
